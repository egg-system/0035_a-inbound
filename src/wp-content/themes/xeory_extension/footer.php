...
<div id="footer-cont-content" class="gr4">
              <h4>ブログコンテンツ</h4>
      <div id="footer-gnav-container" class="gnav-container"><ul id="footer-gnav-ul" class="clearfix"><li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-19"><a href="https://a-inbound.com/">Top</a></li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-20"><a href="http://a-inbound.com/faq/">FAQ</a></li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-21"><a href="http://a-inbound.com/contact/">お問合せ</a></li>
<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-22"><a href="http://a-inbound.com/member/">会員向けページ</a></li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-23"><a href="http://a-inbound.com/membership-registration/">新規会員登録</a></li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-115"><a href="http://a-inbound.com/company/">会社概要</a></li>
</ul></div>    </div>
